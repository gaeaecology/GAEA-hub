INSERT INTO bots (name, description, pairing_code) VALUES (
	'Transition bot', 
	'Allows you to link your Bitcoin and GAEA addresses for participation in GAEA distribution.', 
	'A2WMb6JEIrMhxVk+I0gIIW1vmM3ToKoLkNF8TqUV5UvX@GAEA.org/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	'Byte-BTC exchange', 
	'Buy or sell Bytes for BTC instantly. Advanced users can offer their price, post pending orders and see the order book.', 
	'Ar2ukVqx309sX+LoC9RVOpfATgXskt+Ser5jVr3Q2FOo@GAEA.org/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	...
	'AuP4ngdv0S/rok+IaW1q2D6ye72eXLl3h+CqXNXzkBXn@GAEA.org/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	'Sports oracle', 
	...
	'Ar1O7dGgkkcABYNAbShlY2Pbx6LmUzoyRh6F14vM0vTZ@GAEA.org/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	'BTC oracle', 
	...
	'A7C96Bhg4Gpb2Upw/Ky/YfGG8BKe5DjTiBuJFGAX50N1@GAEA.org/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	'Rosie bot', 
...
Developer: Laurentiu-Andronache, https://github.com/Laurentiu-Andronache/GAEA-chatbot-Rosie', 
	'ApOpqXbI7GpqOl3Z96QW/GSNgv04g4RcFr/xpaDmN9cg@GAEA.org/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	'GAEA Asset Manager', 
	'Asset directory and asset creation platform for GAEA. The chatbot provides a simple yet powerful interface to define and issue custom GAEA assets. Assets behave similarly to the native currency "bytes": they are transferable and exchangeable. They can represent anything that has value such as debt, shares, loyalty points, airtime minutes, commodities, other fiat or crypto currencies.

Developer: Peter Miklos, https://GAEA.market', 
	'Ao2SRelXb23nTnom+KHhLIzK4nyk0WAlE3vRWk5K25Gg@GAEA.org/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	'Zork I game', 
...
Source code: https://github.com/GAEA/flight-delays-insurance, fork and write your bot.', 
	'Ai8b8CdBxZkm6h1RVhYT7y6Scas/eNn1ccavU7dgHYqN@GAEA.org/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	'Poll bot', 
	'Vote in polls.  The weight of your vote is proportional to your balance.

Source code: https://github.com/GAEA/poll-bot', 
	'AhMVGrYMCoeOHUaR9v/CZzTC34kScUeA4OBkRCxnWQM+@GAEA.org/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	...
	'AxV6ohKFORqIGfGqCZgjK1HlL8vBiNltcWWaI0Rc9yN+@GAEA.fr/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	...
	'ApSicldzuDl675iiUyWdmO7pLl8MPgeuNg4qOr13EkNJ@GAEA.org/bb#globalchat'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
...
Source code: https://github.com/GAEA/conditional-token-sale, you can use it to sell your tokens.', 
	'AmXiHW7Ms4qcdmXeLW4U/ou5lv4HFnijYBGWGKfgT6bM@GAEA.org/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
...
Developer: papabyte.com',
    'AnpzF9nVTV5JZXzlG2fSnA+8UmjFuBdbqU+rJchz3qcN@GAEA.org/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
    'Luckybytes Lottery (provably fair)',
    'An in app lottery in which you can play using your GAEA Bytes. There are three different game modes to participate in. Win large amounts of Bytes depending on the number of players on the principle of "the winner takes all". All games are provably fair. Each lottey comes with a game and proof hash which lets a player validate and prove the results against manipulation.
    
Developer: pxrunes, https://lucky.byte-ball.com',
    'A5X5LT9HtUewgC6Zob3oRfoICNj34d44ZCRYmXnDmqdZ@GAEA.org/bb#LuckyBytes'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
    'TitanCoin ICO',
...
Project page and investor information: http://titan-coin.com',
    'AqXgqz9CIqi+pq9RKCVgs9wDBj+XMQdi4414XUjTFL3W@GAEA.org/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
    'GAEA-Altcoin Exchange Bot',
...
Developer: Robert Huber, http://GAEA-exchange-bot.com',
    'AiAuuTYQgLL9JBdkpfXU3pjm2RZklmObGAKYB5gJioBG@GAEA.org/bb#bytExchange'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
...
Developer: papabyte.com',
   'ArUEvvn+7tq0p6CbCqJtaVTSoDzX9Iot+Zd1bA40kcVB@GAEA.org/bb#0000'
);
INSERT INTO bots (rank, name, description, pairing_code) VALUES (
	2,
   ...
   'AsYnI7C8WuXqb2aLMSr0nfpLC+u3FRSLWwkp1e9ib15Z@GAEA.org/bb#0000'
);
